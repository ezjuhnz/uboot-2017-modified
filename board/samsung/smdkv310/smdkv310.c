...
static void smc9115_pre_init(void)
{
	...
	gpio_cfg_pin(EXYNOS4_GPIO_Y00 + CONFIG_NR_DRAM_BANKS, S5P_GPIO_FUNC(2));

	/* Ethernet needs bus width of 16 bits */
	smc_bw_conf = SROMC_DATA16_WIDTH(CONFIG_NR_DRAM_BANKS);
	...
	s5p_config_sromc(CONFIG_NR_DRAM_BANKS, smc_bw_conf, smc_bc_conf);
}
